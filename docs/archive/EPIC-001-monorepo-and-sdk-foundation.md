...
Set up the open-source Bun monorepo, AI agent guidelines, Graphify integration, documentation hierarchy, core `@webmcp/sdk` package, and an example agentic app.

## Tasks

- [x] Configure root `package.json`, `tsconfig.json`, `bunfig.toml`, and `.gitignore`.
- [x] Create AI guidelines (`AGENTS.md`, `CLAUDE.md`).
